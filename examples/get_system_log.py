...
def add_helpmessage(parser):
    ...
    parser.add_argument('--severity', nargs="*", type=str, default='error warning info', help='Specify severity to filter log with severity. "error", "warning", "info" are supported. use space to seperate them. example: event1 event2.')
