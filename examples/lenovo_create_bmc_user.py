...
def add_helpmessage(argget):
    ...
    help_str += "For customized privileges, you can choose one or more values in this list: use space to seperate them. example: event1 event2."
    ...
    help_str1 += "You can choose one or more values in this list: [Redfish, WebUI, ManagerConsole, SNMP, IPMI]. use space to seperate them. example: event1 event2."
