...
def get_server_boot_once_types(ip, login_account, login_password, system_id):
    ...
    :returns: returns server boot once types when succeeded or error message when failed
    """
    result = {}
    login_host = "https://" + ip
    try:
...
if __name__ == '__main__':
    ...
    # Get server boot once types and check result
    result = get_server_boot_once_types(ip, login_account, login_password, system_id)
