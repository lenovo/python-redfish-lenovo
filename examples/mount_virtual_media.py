...
def add_helpmessage(argget):
    ...
    argget.add_argument('--fsusername', type=str, nargs='?',
                        help='Username to access the file path, available for CIFS, HTTP')
    argget.add_argument('--fspassword', type=str, nargs='?',
                        help='Password to access the file path, password should be encrypted after object creation, available for CIFS, HTTP')
