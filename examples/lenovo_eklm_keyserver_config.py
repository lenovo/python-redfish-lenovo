...
def add_helpmessage(parser):
    ...
    parser.add_argument('--kmhostname', nargs="*", type=str, required=True,
                         help='Key management server hostname or IP address. Up to 4 servers are supported. use space to seperate them. example: event1 event2.')
    parser.add_argument('--kmport', nargs="*", type=int, default=[5696,5696,5696], required=False,
                         help='The corresponding port for key management server. Default port is 5696. use space to seperate them. example: event1 event2.')
