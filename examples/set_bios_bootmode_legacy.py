...
def set_bios_bootmode_legacy(ip, login_account, login_password, system_id, auth):
...
if __name__ == '__main__':
    ...
    result = set_bios_bootmode_legacy(ip, login_account, login_password, system_id, auth)
