...
def get_bios_attribute(ip, login_account, login_password, system_id, auth, attribute_name):
...
if __name__ == '__main__':
    ...
    result = get_bios_attribute(ip, login_account, login_password,system_id, auth, attribute_name)
