...
def add_helpmessage(argget):
    ...
    argget.add_argument('--dnsserver',  nargs="*", type=str, required=False, help='Specify the names of DNS servers, up to 3 DNS servers can be used. use space to seperate them. example: event1 event2.')
